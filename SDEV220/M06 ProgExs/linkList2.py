'''
    ...
    Implemenet the following methods:
        remove(e)
...
# Remove the element and return true if the element is in the list 
    def remove(self, e):
        if self.__size == 0 or self.indexOf(e) == -1:
            return False

        else:
            self.removeAt(self.indexOf(e))
            return True
...
#  Return -1 if no match. 
    def lastIndexOf(self, e):
        if self.getSize() == 0 or self.indexOf(e) == -1:
            return False
        
        else:
            for i in range(self.getSize() -1, 0, -1):
                if e == self.get(i):
                    return i
...
#  with the specified element. 
    def set(self, index, e):
        #if self.getSize() == 0 or self.indexOf(e) == -1:    return False
