'''
    ...
    Add the following new methods in BinaryTree
...
def main():
        ...
        binaryTree.root.left = root.left
        root.right = TreeNode(75)
        binaryTree.root.right = root.right
        
        root.left.left = TreeNode(12)
        binaryTree.root.left.left = root.left.left
        root.left.right = TreeNode(30)
        binaryTree.root.left.right = root.left.right
        
        root.right.left = TreeNode(70)
        binaryTree.root.right.left = root.right.left
        root.right.right = TreeNode(80)
        binaryTree.root.right.right = root.right.right
        
        root.left.left.left = TreeNode(10)
        binaryTree.root.left.left.left = root.left.left.left
        
        height = binaryTree.height(root)
        print("height: ", height)
        print("\nBFT: ")
        bfTraversal = binaryTree.breadthFirstTraversal(root)
